...
class _TeacherPageState extends State<TeacherPage> {
  ...
  AlertDialog alertDialog() {
    return AlertDialog(
      ...
      content: const Text(
          'В столбце "Курсовые преподавателя" находится список курсовых проектов, которые созданны данным преподавателем.'
          '\nКнопка "Обновить" - обновляет данный список.'
          '\nКнопка "Новая" - начинает создание нового курсового проекта.'
          '\nКнопка "Подтвердить" - делает выделенный в списке курсовой проект в качестве текущего, то есть все изменения, будут применяться к нему.'
          '\n\nВ поле "Название курсового проекта" нужно ввести название для создаваемого проекта.'
          '\nЕсли поле оставить пустым, курсовую создать не получится.'
          '\n\nВ поле "Описание курсового проекта" нужно ввести описание создаваемого проекта.'
          '\n\nСписок, состоящий из двух столбцов, отвечает за выбранные предпочтения, которые должны быть у студента для данной курсовой.'
          '\nДанные слова должны описывать тему курсового проекта.'
          ...
          '\nКнопка "Создать" - создаёт курсовой проект с указанными данными.'
          '\nКнопка "Подтвердить" - подтверждает сделанные изменения в курсовом проекте.'),
      actions: [
        TextButton(
            onPressed: () {
        ...
        child: Form(
          ...
          child: TextFormField(
            ...
            decoration: const InputDecoration(
                labelText: "Название курсового проекта",
                border: InputBorder.none),
            validator: (value) {
              if (value == null || value.isEmpty) {
                return "Введите название курсового проекта";
              }
              return null;
            },
          ),
