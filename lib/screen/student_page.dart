  ...
  AlertDialog alertDialog() {
    return AlertDialog(
      ...
      content: const Text(
          ...
          '\n\nСписок посередине, состоящий из трёх столбцов, отвечает за выбранные курсовые работы.'
          '\nВыбор осуществляется перетягиванием из среднего столбца курсовых влево или вправо. '
          '\nПеремещение из левого или правого столбца в средний осуществляется нажатием по названию курсовой работы.'
